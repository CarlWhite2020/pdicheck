package com.eucleia.pdicheck.widget.wheelpicker.widgets;
...
import com.eucleia.pdicheck.widget.wheelpicker.IWheelPicker;
import com.eucleia.pdicheck.widget.wheelpicker.WheelPicker;
...
public class WheelDatePicker extends LinearLayout implements WheelPicker.OnItemSelectedListener,
    ...
    public void onItemSelected(WheelPicker picker, Object data, int position) {
        ...
        mDay = mPickerDay.getCurrentDay();
        String date = mYear + CharVar.MINUS  + mMonth + CharVar.MINUS  + mDay;
        if (null != mListener) try {
            mListener.onDateSelected(SDF.parse(date));
    ...
    public void setItemTextSize(int size, boolean invalidate) {
        mPickerYear.setItemTextSize(size, invalidate);
        mPickerMonth.setItemTextSize(size, invalidate);
        mPickerDay.setItemTextSize(size, invalidate);
    }
