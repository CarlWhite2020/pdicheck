...
public class ModelFlowLayout extends ViewGroup {
    private int lineSpacing = 0;
    private int itemSpacing = 0;
    private boolean singleLine = false;
    private int rowCount;

    public ModelFlowLayout(Context context) {
        super(context);
    }

    public ModelFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void loadFromAttributes(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        lineSpacing = array.getDimensionPixelSize(R.styleable.ModelFlowLayout_lineSpacing, 0);
        itemSpacing = array.getDimensionPixelSize(R.styleable.ModelFlowLayout_itemSpacing, 0);
        array.recycle();
    }
    ...
    public void setModel(String model) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (child instanceof AppCompatTextView) {
                if (TextUtils.equals(model,  ((AppCompatTextView) child).getHint())) {
