package com.eucleia.tabscanap.util.immersionbar.components;
 ...
 * @date 2017 /5/12
 */
public abstract class SimpleImmersionBaseFragment extends BaseFragment implements SimpleImmersionOwner {
